<template>
  <div>
        ...
        <div class="wrap-box">
          ...
          <div class="left-220">
            <ul class="side-img-list">
              <!-- 用动态数据渲染页面 -->
              <!-- 'v-bind' directives require an attribute value (vue/valid-v-bind) at src\components\index.vue:164:65: 报错！！ -->
              <!--  v-for 后添加 :key='item' 解决报错 -->
    ...
    <div class="section" v-for="item in goodList" :key="item">
      <div class="main-tit">
